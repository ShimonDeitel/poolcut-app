...
struct ContentView: View {
    ...
    @State private var editingItem: Entry?
    ...
    private func amountText(_ item: Entry) -> String? {
...
struct EntryFormView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section {
                    TextField("Member", text: $draft.member)
                        .accessibilityIdentifier("field_member")
